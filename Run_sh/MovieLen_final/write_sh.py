...
# '[ConUCB_TV1.7]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7]'
...
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.1]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.2]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.3]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.4]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.5]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.6]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.7]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.8]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho0.9]',
# '[Gopt-Pro_gf_1-hop-tanimoto+CosSim_SumOuter_TV1.7_RSetting1_RMRho1.0]',

'[CtoF-ConUCB+_TV1.7_U10_I10]'
]

cnt = 0
for sufix in suffix:
    # fg = "/data/czzhao_hdd/GraphCRS/Run/{}/{}.json".format(ds, sufix)
    fg = "/mnt/czzhao_hdd/Gitee/GraphCRS/Run/{}/{}.json".format(ds, sufix)
    config = ""
